        ...
        <section className="flex-1 overflow-y-auto px-8 py-7">
          <div className="min-h-full rounded-[14px] border border-[#dfe4f0] bg-white p-8">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-[13px] text-[#7b8499]">
                  Track all your previous fee payment transactions
                </p>
              </div>
            ...
            <div className="mt-8 rounded-[12px] border border-[#dfe4f0] bg-white p-6">
                ...
                <div className="flex gap-3">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="h-[42px] w-[240px] rounded-md border border-[#dfe4f0] bg-white pl-10 pr-4 text-[13px] outline-none placeholder:text-[#8a94a8] focus:border-[#25249c]"
                    />
                  </div>
              ...
              <div className="mt-5 flex items-center justify-between text-[13px] text-[#6b7280]">
