  ...
  return (
    <div className="w-full rounded-[14px] border border-[#dfe4f0] bg-white p-6">
      <div className="mb-5 flex items-center justify-between">
        <div>
          <h1 className="text-[20px] font-bold text-[#07185f] md:text-[24px]">
            Transaction Receipt
          </h1>
          <p className="mt-1 text-[12px] text-[#6b7280] md:text-[13px]">
      ...
      <div className="mx-auto max-w-[760px] rounded-[12px] border border-[#dfe4f0] bg-white p-7 shadow-[0_10px_28px_rgba(15,23,42,0.07)]">
        <div className="border-b border-[#e4e8f2] pb-5 text-center">
          ...
          <h3 className="mt-5 text-[18px] font-bold text-[#07185f] md:text-[20px]">
            Payment Receipt
          </h3>
        </div>
          ...
          <table className="w-full text-[14px]">
            <thead className="bg-[#eef0ff] text-[#07185f]">
              <tr>
                ...
                <th className="px-5 py-3 text-center font-bold">Periods</th>
